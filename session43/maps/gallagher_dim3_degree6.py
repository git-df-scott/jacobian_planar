...
# -*- coding: utf-8 -*-
"""
Gallagher's dimension-3 counterexample of GEOMETRIC DEGREE 6  (det J = 1)

A non-injective Keller map C^3 -> C^3 whose generic fibre has exactly 6 points.
This is the member n = 6 (seed degree d = 5) of the PUBLISHED infinite family
...
Seed family (his eq. (5)), here with d = 5, c = 1:
  p_d(w) = 2w - 3w^2 + w(1-w)( w^(d-2) - k ),   k = 6/(d(d+1))
  -> p_5(w) = -w**5 + w**4 - 14*w**2/5 + 9*w/5
...
Run:  python3 gallagher_dim3_degree6.py
...
# ===========================================================================
F1 = (
    (R(-5, 6))*x**12*y**6*z**4 + (R(95, 21))*x**11*y**7*z**3 + (R(-1805, 196))*x**10*y**8*z**2
    + (-5)*x**11*y**5*z**4 + (R(34295, 4116))*x**9*y**9*z + (R(500, 21))*x**10*y**6*z**3
    + (R(-651605, 230496))*x**8*y**10 + (R(-4085, 98))*x**9*y**7*z**2
    + (R(-25, 2))*x**10*y**4*z**4 + (R(10830, 343))*x**8*y**8*z + (R(1703, 35))*x**9*y**5*z**3
    + (R(-994555, 115248))*x**7*y**9 + (R(-63667, 980))*x**8*y**6*z**2
    + (R(-50, 3))*x**9*y**3*z**4 + (R(222699, 6860))*x**7*y**7*z + (R(934, 21))*x**8*y**4*z**3
    + (R(-1390933, 384160))*x**6*y**8 + (R(-6002, 245))*x**7*y**5*z**2
    + (R(-25, 2))*x**8*y**2*z**4 + (R(-54709, 3430))*x**6*y**6*z + (R(193, 21))*x**7*y**3*z**3
    + (R(1165251, 96040))*x**5*y**7 + (R(7393, 196))*x**6*y**4*z**2 + (-5)*x**7*y*z**4
    + (R(-314061, 6860))*x**5*y**5*z + (R(-104, 7))*x**6*y**2*z**3
    + (R(4324651, 384160))*x**4*y**6 + (R(3895, 98))*x**5*y**3*z**2 + (R(-5, 6))*x**6*z**4
    + (R(-4731, 343))*x**4*y**4*z + (R(-241, 21))*x**5*y*z**3 + (R(-880741, 192080))*x**3*y**5
    + (R(967, 196))*x**4*y**2*z**2 + (R(284399, 20580))*x**3*y**3*z + (R(-38, 15))*x**4*z**3
    + (R(-5564609, 1152480))*x**2*y**4 + (R(-269, 35))*x**3*y*z**2 + (R(1597, 490))*x**2*y**2*z
    + (R(113843, 20580))*x*y**3 + (R(-13, 5))*x**2*z**2 + (R(-229, 35))*x*y*z
    + (R(4379, 980))*y**2 + (R(-14, 5))*z
)

F2 = (
    (-1)*x**12*y**5*z**4 + (R(38, 7))*x**11*y**6*z**3 + (R(-1083, 98))*x**10*y**7*z**2
    + (-5)*x**11*y**4*z**4 + (R(6859, 686))*x**9*y**8*z + (R(162, 7))*x**10*y**5*z**3
    + (R(-130321, 38416))*x**8*y**9 + (R(-3819, 98))*x**9*y**6*z**2 + (-10)*x**10*y**3*z**4
    + (R(19133, 686))*x**8*y**7*z + (R(247, 7))*x**9*y**4*z**3 + (R(-267501, 38416))*x**7*y**8
    + (R(-3837, 98))*x**8*y**5*z**2 + (-10)*x**9*y**2*z**4 + (R(15485, 1372))*x**7*y**6*z
    + (R(128, 7))*x**8*y**3*z**3 + (R(24187, 9604))*x**6*y**7 + (R(444, 49))*x**7*y**4*z**2
    + (-5)*x**8*y*z**4 + (R(-10169, 343))*x**6*y**5*z + (R(-48, 7))*x**7*y**2*z**3
    + (R(225929, 19208))*x**5*y**6 + (R(3447, 98))*x**6*y**3*z**2 + (-1)*x**7*z**4
    + (R(-8434, 343))*x**5*y**4*z + (R(-74, 7))*x**6*y*z**3 + (R(64887, 38416))*x**4*y**5
    + (R(1185, 98))*x**5*y**2*z**2 + (R(5207, 686))*x**4*y**3*z + (-3)*x**5*z**3
    + (R(-259513, 38416))*x**3*y**4 + (R(-81, 14))*x**4*y*z**2 + (R(7331, 980))*x**3*y**2*z
    + (R(27481, 13720))*x**2*y**3 + (-3)*x**3*z**2 + (R(-191, 35))*x**2*y*z
    + (R(6009, 980))*x*y**2 + (R(-19, 5))*x*z + (R(5, 14))*y
)

F3 = (
    (1)*x**3*z + (R(-19, 14))*x**2*y + (1)*x
)

F = [F1, F2, F3]

# --- Gallagher's generating data ------------------------------------------
P_OF_W = (-1)*w**5 + (1)*w**4 + (R(-14, 5))*w**2 + (R(9, 5))*w**1
Q_OF_W = (R(-5, 6))*w**6 + (R(4, 5))*w**5 + (R(-28, 15))*w**3 + (R(9, 10))*w**2
A_CONST = R(-19, 14)
B_CONST = 1
C_CONST = 1
SEED_D = 5
