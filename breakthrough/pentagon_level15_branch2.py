...
def build_generic_branch():
    ...
    return {
        "h": {8: c0*z**8, 7: h7, 6: h6.subs(conditions).subs(generic),
              5: h5.subs(generic), 4: h4},
        "g": {12: g12, 11: g11.subs(conditions).subs(generic),
              10: g10.subs(conditions).subs(generic),
              9: g9.subs(conditions).subs(generic),
              8: g8.subs(generic)},
        "conditions": C,
        "generic_substitution": {**conditions, **generic},
        "F2": F2,
        "F3": F3,
    }
