# night14 CRUX_c3a90800f935

Object (ring: Q[x,y]), family F2 -- F2 n=2 c=3 a=0 h0=1 t=[(0, Fraction(-2, 1)), (1, Fraction(3, 1))]

    P   = (27/4)*x^4 + 9*x^3*y + 3*x^2*y^2 - 9*x^3 - 6*x^2*y + 3*x^2 + (3/2)*x + y - 1
    P_x = 27*x^3 + 27*x^2*y + 6*x*y^2 - 27*x^2 - 12*x*y + 6*x + (3/2)
    P_y = 9*x^3 + 6*x^2*y - 6*x^2 + 1
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='c3a90800f935'][0]; \
