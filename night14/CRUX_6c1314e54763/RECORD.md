# night14 CRUX_6c1314e54763

Object (ring: Q[x,y]), family F2 -- F2 n=1 c=1 a=0 h0=1 t=[(0, Fraction(-1, 1)), (1, Fraction(-1, 1))]

    P   = (1/4)*x^3 - 1*x^2*y + x*y^2 + (1/2)*x^2 - 1*x*y + (-1/4)*x + y + (-1/2)
    P_x = (3/4)*x^2 - 2*x*y + y^2 + x - 1*y + (-1/4)
    P_y = -1*x^2 + 2*x*y - 1*x + 1
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='6c1314e54763'][0]; \
