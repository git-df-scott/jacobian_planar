# night14 CRUX_020cc92ed4f1

Object (ring: Q[x,y]), family F4 -- F4 random sparse (3 terms)

    P   = 3*x^3*y^2 - 3*x^2*y + x
    P_x = 9*x^2*y^2 - 6*x*y + 1
    P_y = 6*x^3*y - 3*x^2

total degree 5, deg_x 3, deg_y 2, 3 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='020cc92ed4f1'][0]; \
