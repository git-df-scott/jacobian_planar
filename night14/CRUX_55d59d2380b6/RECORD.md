# night14 CRUX_55d59d2380b6

Object (ring: Q[x,y]), family F2 -- F2 n=2 c=1 a=0 h0=-3 t=[(0, Fraction(-3, 1))]

    P   = x^2*y^2 - 3*x^2*y + (9/4)*x^2 - 3*y + (9/2)
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='55d59d2380b6'][0]; \
