# night14 CRUX_b7420192a326

Object (ring: Q[x,y]), family F1b -- F1b c1*x + c2*x^2*y^3 (+extra), top form has factors x and y

    P   = -1*x^2*y^3 + x
    P_x = -2*x*y^3 + 1
    P_y = -3*x^2*y^2

total degree 5, deg_x 2, deg_y 3, 2 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='b7420192a326'][0]; \
