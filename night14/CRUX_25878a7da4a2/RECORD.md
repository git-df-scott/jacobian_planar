# night14 CRUX_25878a7da4a2

Object (ring: Q[x,y]), family F2 -- F2 n=1 c=3 a=0 h0=-3 t=[(0, Fraction(2, 1))]

    P   = 3*x*y^2 + 6*x*y + 3*x - 3*y - 3
    P_x = 3*y^2 + 6*y + 3
    P_y = 6*x*y + 6*x - 3
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='25878a7da4a2'][0]; \
