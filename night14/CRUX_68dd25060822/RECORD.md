# night14 CRUX_68dd25060822

Object (ring: Q[x,y]), family F2b -- F2b n=1 c=2 h0=2 d_n=1 s=[(0, Fraction(3, 1))]

    P   = 2*x*y^2 + 3*x*y + (9/8)*x + 2*y + (11/8)
    P_x = 2*y^2 + 3*y + (9/8)
    P_y = 4*x*y + 3*x + 2
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='68dd25060822'][0]; \
