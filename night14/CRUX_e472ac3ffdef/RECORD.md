# night14 CRUX_e472ac3ffdef

Object (ring: Q[x,y]), family F2 -- F2 n=4 c=2 a=1 h0=2 t=[(0, Fraction(3, 1))]

    P   = 2*x^4*y^2 + 6*x^4*y - 8*x^3*y^2 + (9/2)*x^4 - 24*x^3*y + 12*x^2*y^2 - 18*x^3 + 36*x^2*y - 8*x*y^2 + 27*x^2 - 24*x*y + 2*y^2 - 18*x + 8*y + (15/2)
    P_x = 8*x^3*y^2 + 24*x^3*y - 24*x^2*y^2 + 18*x^3 - 72*x^2*y + 24*x*y^2 - 54*x^2 + 72*x*y - 8*y^2 + 54*x - 24*y - 18
    P_y = 4*x^4*y + 6*x^4 - 16*x^3*y - 24*x^3 + 24*x^2*y + 36*x^2 - 16*x*y - 24*x + 4*y + 8

total degree 6, deg_x 4, deg_y 2, 15 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='e472ac3ffdef'][0]; \
