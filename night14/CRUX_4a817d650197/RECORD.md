# night14 CRUX_4a817d650197

Object (ring: Q[x,y]), family F2 -- F2 n=2 c=-1 a=0 h0=2 t=[(0, Fraction(-3, 1))]

    P   = -1*x^2*y^2 + 3*x^2*y + (-9/4)*x^2 + 2*y - 3
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='4a817d650197'][0]; \
