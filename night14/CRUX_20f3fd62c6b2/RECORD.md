# night14 CRUX_20f3fd62c6b2

Object (ring: Q[x,y]), family F1b -- F1b c1*x + c2*x^5*y^1 (+extra), top form has factors x and y

    P   = 2*x^5*y + 3*x
    P_x = 10*x^4*y + 3
    P_y = 2*x^5

total degree 6, deg_x 5, deg_y 1, 2 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='20f3fd62c6b2'][0]; \
