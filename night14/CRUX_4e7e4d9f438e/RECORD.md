# night14 CRUX_4e7e4d9f438e

Object (ring: Q[x,y]), family F2b -- F2b n=5 c=2 h0=-1 d_n=3 s=[]

    P   = 2*x^5*y^2 - 1*y + (-3/8)
    P_x = 10*x^4*y^2
    P_y = 4*x^5*y - 1

total degree 7, deg_x 5, deg_y 2, 3 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='4e7e4d9f438e'][0]; \
