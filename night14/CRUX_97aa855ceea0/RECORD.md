# night14 CRUX_97aa855ceea0

Object (ring: Q[x,y]), family F2b -- F2b n=2 c=2 h0=1 d_n=-2 s=[(0, Fraction(-3, 1))]

    P   = 2*x^2*y^2 - 3*x^2*y + (9/8)*x^2 + y + (-1/2)
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='97aa855ceea0'][0]; \
