# night14 CRUX_416f3d522bbf

Object (ring: Q[x,y]), family F3 -- F3 u+u^2*w, w=y+f(x) deg f=0

    P   = x^2*y + x^2 + x
    P_x = 2*x*y + 2*x + 1
    P_y = x^2

total degree 3, deg_x 2, deg_y 1, 3 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='416f3d522bbf'][0]; \
