# night14 CRUX_ea597f11ee80

Object (ring: Q[x,y]), family F1b -- F1b c1*x + c2*x^4*y^2 (+extra), top form has factors x and y

    P   = x^4*y^2 + 2*x
    P_x = 4*x^3*y^2 + 2
    P_y = 2*x^4*y

total degree 6, deg_x 4, deg_y 2, 2 terms.
...
## Reproduce
    ...
    cd night14 && python3 -c "import json, poly14 as P, sy14, utest14, fib14; \
      r = [r for r in json.load(open('records.json')) if r['hash']=='ea597f11ee80'][0]; \
